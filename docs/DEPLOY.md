...
- docs/services/ — chi tiết từng service
- docs/services/litestream.md — backup config
- docs/services/deploy-code.md — sidecar deploy
- docs/services/app.md — Repo Agent Launcher chi tiết
